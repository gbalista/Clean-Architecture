...
public class ArcJobActivator : JobActivator
{
    private readonly IServiceScopeFactory _scopeFactory;

    public ArcJobActivator(IServiceScopeFactory scopeFactory) =>
    ...
    private sealed class Scope : JobActivatorScope, IServiceProvider
    {
        ...
        {
            var tenantInfo = _context.GetJobParameter<ArcTenantInfo>(TenantConstants.Identifier);
